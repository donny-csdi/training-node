...
var findAll = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, prismaClient_config_1.default.blog.findMany()];
    });
}); };
var findById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, prismaClient_config_1.default.blog.findUnique({
                where: { id: id },
            })];
    });
}); };
var create = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, prismaClient_config_1.default.blog.create({
                data: data,
            })];
    });
}); };
var update = function (id, data) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, prismaClient_config_1.default.blog.update({
                where: { id: id },
                data: data,
            })];
    });
...
var remove = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, prismaClient_config_1.default.blog.delete({
                where: { id: id },
            })];
    });
}); };
