...
var findAll = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, prismaClient_config_1.default.iklan.findMany({
                include: {
                    car: {
                        select: {
                            id: true,
...
var findById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, prismaClient_config_1.default.iklan.findUnique({
                where: { id: id },
                include: {
                    car: true,
                },
...
var create = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, prismaClient_config_1.default.iklan.create({
                data: data,
            })];
    });
}); };
var update = function (id, data) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, prismaClient_config_1.default.iklan.update({
                where: { id: id },
                data: data,
            })];
    });
...
var remove = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, prismaClient_config_1.default.iklan.delete({
                where: { id: id },
            })];
    });
}); };
...
exports.default = SIklan;
//# sourceMappingURL=iklan.service.js.map