...
var findAll = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, prismaClient_config_1.default.car.findMany({
                include: {
                    iklan: {
                        select: {
                            id: true,
...
var findById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, prismaClient_config_1.default.car.findUnique({
                where: { id: id },
                include: {
                    iklan: true,
                },
...
var create = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, prismaClient_config_1.default.car.create({
                data: data,
            })];
    });
}); };
var update = function (id, data) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, prismaClient_config_1.default.car.update({
                where: { id: id },
                data: data,
            })];
    });
...
var remove = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, prismaClient_config_1.default.car.delete({
                where: { id: id },
            })];
    });
}); };
