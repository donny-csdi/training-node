...
var findAll = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, prismaClient_config_1.default.promo.findMany({
                include: {
                    articles: {
                        select: {
                            id: true,
...
var findById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, prismaClient_config_1.default.promo.findUnique({
                where: {
                    id: id,
                },
                include: {
...
var create = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, prismaClient_config_1.default.promo.create({
                data: data,
            })];
    });
}); };
var update = function (id, data) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, prismaClient_config_1.default.promo.update({
                where: { id: id },
                data: data,
            })];
    });
...
var remove = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, prismaClient_config_1.default.promo.delete({
                where: { id: id },
            })];
    });
}); };
